...
// Create the table
$tableCreation = "CREATE TABLE IF NOT EXISTS c" . $clientId . "_p" . $projectId . "_comments ( id_surface INT UNSIGNED NOT NULL, comment VARCHAR(200), PRIMARY KEY (id_surface) ) CHARACTER SET 'utf8' ENGINE=INNODB;";
...
//Insert comment
$insertCmd = "REPLACE INTO c" . $clientId . "_p" . $projectId . "_comments (id_surface, comment) VALUES ( '" . $surfaceID . "', '" . $comment . "');";
