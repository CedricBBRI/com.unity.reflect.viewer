...
$tableCreation = "CREATE TABLE IF NOT EXISTS c" . $clientId . "_p" . $projectId . "_choices ( id_surface INT UNSIGNED NOT NULL, id_tile SMALLINT UNSIGNED NOT NULL, surface_price DOUBLE UNSIGNED, PRIMARY KEY (id_surface) ) CHARACTER SET 'utf8' ENGINE=INNODB;";
