...
// Create the table
$tableCreation = "CREATE TABLE IF NOT EXISTS c" . $clientId . "_p" . $projectId . "_screenshots ( id_surface INT UNSIGNED NOT NULL, filename VARCHAR(50), positionX FLOAT NOT NULL, positionY FLOAT NOT NULL, positionZ FLOAT NOT NULL, rotationX FLOAT NOT NULL, rotationY FLOAT NOT NULL, rotationZ FLOAT NOT NULL, PRIMARY KEY (id_surface) ) CHARACTER SET 'utf8' ENGINE=INNODB;";
...
//Insert comment
$insertCmd = "REPLACE INTO c" . $clientId . "_p" . $projectId . "_screenshots (id_surface, filename, positionX, positionY, positionZ, rotationX, rotationY, rotationZ) VALUES ( '" . $surfaceID . "', '" . $filename . "', '" . $positionX . "', '" . $positionY . "', '" . $positionZ . "', '" . $rotationX . "', '" . $rotationY . "', '" . $rotationZ . "');";
